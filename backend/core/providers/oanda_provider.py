"""OANDA data provider architecture stub."""
...
class OandaProvider(BaseDataProvider):
    """Architecture stub for an OANDA-backed market data provider."""

    name: str = "oanda"

    def connect(self) -> None:
        """Establish a connection to the OANDA provider."""

    def disconnect(self) -> None:
        """Close the connection to the OANDA provider."""
    ...
    def get_candles(self, symbol: str, timeframe: str, limit: int = 100) -> list[Candle]:
        """Return a list of OHLCV candles for the requested instrument."""
        return []
